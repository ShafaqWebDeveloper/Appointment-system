                  ...
                  <div class="card-body">
                    <form id="data" class="forms-sample">
                      ...
                      <div class="form-group">
                        <label>Name</label>
                        <input value="{{$alldata['dname']}}" type="text" name="dname" id="dname" class="form-control">
                        <small id="cdname" style="color:red;">must contain at least 3 letters and numbers are not allowed</small>
                      </div>
                      <div class="form-group">
                        <label>Father Name</label>
                        <input value="{{$alldata['dfname']}}" type="text" name="dfname" id="dfname" class="form-control">
                        <small id="cdfname" style="color:red;">must contain at least 3 letters and numbers are not allowed</small>
                      </div>
                      <div class="form-group">
                        <label>Gender</label></br>
                        Male&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input value="{{$alldata['dgen']}}" type="radio" name="dgen" value="Male"></br>
                        Female&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input value="{{$alldata['dgen']}}" type="radio" name="dgen" value="Female">
                        <small id="dgen" ></small>
                      </div>
                      <div class="form-group">
                        <label>Specialiaty</label>
                        <select name="dspec" class="form-control">
                          <option value="{{$alldata['dspec']}}">{{$alldata['dspec']}}</option>
                      ...
                      <div class="form-group">
                        <label>Mobile</label>
                        <input value="{{$alldata['dmobile']}}" type="number" id="dmobile" name="dmobile" class="form-control">
                        <small id="cdmobile" style="color:red;">11 numbers</small>
                      </div>
                      <div class="form-group">
                        <label>Email</label>
                        <input value="{{$alldata['demail']}}" type="text" name="demail" id="demail" class="form-control">
                        <small id="cdemail" style="color:red;">write correct pattern as example@domain.com</small>
                      </div>
                      <div class="form-group">
                        <label>Password</label>
                        <input value="{{$alldata['dpass']}}" type="text" name="dpass" class="form-control" id="dpass">
                      ...
                      <div class="form-group">
                        <label>Pic</label>
                        <input value="{{$alldata['dpic']}}" type="file" name="dpic" class="form-control">
                        <small id="dpic" style="color:red;"></small>
                      </div>
                      <button type="submit" class="btn btn-primary mr-2" id="sub" data-id="{{$alldata['did']}}">Update</button>
