                                    ...
                                    <form id="data">
                                        ...
                                        <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    <input type="text" class="form-control border-top-0border-right-0 border-left-0" name="pname"value="{{$p['pname']}}"  id="pname" placeholder="patient Name">
                                                    <small id="cpname" style="color:red;">must contain at least 3 letters and numbers are not allowed</small>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    <input type="text" class="form-control border-top-0 border-right-0 border-left-0" name="pfname" value="{{$p['pfname']}}" id="pfname" placeholder="patient FatherName">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    <input type="number" class="form-control border-top-0 border-right-0 border-left-0" name="pmobile" value="{{$p['pmobile']}}" id="pmobile" placeholder="Phone">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <option value="{{$p['pdoc']}}">{{$p['pdoc']}}</option>
                                                    @foreach($d as $data)
                                            ...
                                            <div class="col-12 col-md-2">
                                                <div class="form-group">
                                                    <input type="date" 
                                                     class="form-control" value="{{$p['pdate']}}" diabled="{{$p['pdate']}}"  name="pdate" id="pdate" placeholder="Date">
                                            ...
                                            <div class="col-12 col-md-2">
                                                <div class="form-group">
                                                    <input type="Time" class="form-control" value="{{$p['ptime']}}" name="ptime" id="ptime" placeholder="Time">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    <input type="text" class="form-control border-top-0 border-right-0 border-left-0" name="pemail" value="{{$p['pemail']}}" id="pemail" placeholder="Email">
                                                    <small id="cpemail" style="color:red;">write correct pattern as example@domain.com</small>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    <input type="text" class="form-control border-top-0 border-right-0 border-left-0" name="ppass" value="{{$p['ppass']}}" id="ppass" placeholder="Password">
                                            ...
                                            <div class="col-12 col-md-7">
                                                <div class="form-group mb-0">
                                                    <textarea name="psymptoms" class="form-control mb-0 border-top-0 border-right-0 border-left-0" id="symptoms" value="{{$p['psymptoms']}}" cols="30" rows="10" placeholder="Symptoms"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-5 mb-0">
                                                <div class="form-group mb-0">
                                                    <button type="submit" id="sub" data-id="{{$p['pid']}}"class="btn medilife-btn">Make an Appointment <span>+</span></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
...
<script>
   ...
   const pfname=document.getElementById('pfname');
    ...
    // console.log(regx,strn);
    const cpfname=document.getElementById('cpfname');
    if(regx.test(strn)){
      console.log('matched');
